  ...
  let content = `
    <form id="edit-song-form" class="flex flex-col" onsubmit="return false">
        ...
        <div class="edit-song-item flex flex-row items-center">
            ...
            <input type="text" name="album" id="album" class="edit-song-input" value="${song["album"]}" />
        </div>
        <div class="edit-song-item flex flex-row items-center">
        ...
        <div class="edit-song-btns flex flex-row items-center">
            <button id="btn-submit-song" class="edit-song-btn" onclick="submit_song(${song["song_id"]})">Submit</button>
